...
public class MediaItem {
    ...
    public MediaItem(String title, String artist, String album, String path, long duration, long albumId, String composer, int image) {
        this.title = title;
        this.artist = artist;
        this.album = album;
        this.path = path;
